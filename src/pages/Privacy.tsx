...
export default function Privacy() {
  ...
  useEffect(() => {
    fetch('/api/admin?action=get-page-content&page=privacy')
      .then(r => r.json())
  ...
  return (
    <>
      <SEO
        title="Privacy Policy | Golden Lotus Indian Restaurant"
        description="Privacy Policy for Golden Lotus Grill. Learn how we collect, use, and protect your personal information."
        url="https://www.goldenlotusgrill.com/privacy"
        schema={breadcrumbSchema([
          { name: 'Home', url: 'https://www.goldenlotusgrill.com' },
          { name: 'Privacy Policy', url: 'https://www.goldenlotusgrill.com/privacy' },
        ])}
      />
        ...
        <div className="legal-inner">
          ...
          {content.content ? (
            ...
            <div className="legal-placeholder">
              ...
              <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 22, color: '#0F0C08', marginBottom: 8 }}>Privacy Policy coming soon</h3>
              <p style={{ fontSize: 14, color: '#9E8870', maxWidth: 360, margin: '0 auto' }}>Our privacy policy is being updated. Please check back later or contact us directly with any questions.</p>
            </div>
          )}
